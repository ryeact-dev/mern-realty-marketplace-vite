        ...
        <section className='absolute top-0 inset-0 z-40 min-h-screen text-white w-full duration-500 transition ease-in'>
          <div className='grid gap-4 bg-black p-4'>
            ...
            <button
              ...
              className='fixed right-4 top-4 sm:top-64 flex cursor-pointer gap-1 rounded-2xl bg-white px-4 py-2 text-black hover:bg-red-700 hover:text-white md:top-16 lg:right-[4rem] xl:right-[20rem] items-center'
            >
